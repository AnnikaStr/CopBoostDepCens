################################################################################
### DESCRIPTION
### Gumbel_Cop() defines the function to create a Families object from gamboostLSS
### for the Gumbel copula with arbitrary marginal distributions.
...
Gumbel_Cop_depCens <- function(marg1 = NULL, marg2 = NULL,
  ...
  gradient_marg1_gen <- function(derlpdf1, cdf1, cdf2, dercdf1){
    expr({
      ...
      C12 <- exp( - ( (-log(F1))^rho + (-log(F2))^rho )^(1/rho))
      h1 <- C12* (1/F1)*((-log(F1))^(rho-1)) *( ( (-log(F1))^rho + (-log(F2))^rho )^((1/rho)-1))
      h2 <- C12* (1/F2)*((-log(F2))^(rho-1)) *( ( (-log(F1))^rho + (-log(F2))^rho )^((1/rho)-1))
      
      h1_deru1 <- (1/(F1^2))*exp(-((-log(F1))^teta + (-log(F2))^teta)^((1/
                                                                          teta)))* (-log(F1))^(-2 + 
                                                                                                 teta) *((-log(F1))^teta + (-log(F2))^teta)^(-2 + 1/
                                                                                                                                               teta)* ((-log(F1))^
                                                                                                                                                         teta* (log(F1) + ((-log(F1))^teta + (-log(F2))^teta)^(1/
                                                                                                                                                                                                                 teta)) + (1 - teta + log(F1))* (-log(F2))^teta)
      
      h2_deru1 <- (exp(-((-log(F1))^teta + (-log(F2))^teta)^((1/teta)))* (-log(F1))^(-1 + 
                                                                                                    teta) *(-1 + teta + ((-log(F1))^teta + (-log(F2))^teta)^(1/
                                                                                                                                                               teta))* ((-log(F1))^teta + (-log(F2))^teta)^(-2 + 1/
                                                                                                                                                                                                              teta)* (-log(F2))^(-1 + teta))/(F1 *F2)
      
        
      ngr <- (
        
        y[,2] * (  dpdf1 + (1/pdffz(1-h1) * h1_deru1 * (-1) * df1))
        +
  ...
  gradient_marg2_gen <- function(derlpdf2, cdf1, cdf2, dercdf2){
    expr({
      df2 <- (!!dercdf2)
      dpdf2 <- (!!derlpdf2)
      ...
      h1_deru2 <- (exp(-((-log(F1))^teta + (-log(F2))^teta)^((1/teta)))* (-log(F1))^(-1 + 
                                                                                                 teta) *(-1 + teta + ((-log(F1))^teta + (-log(F2))^teta)^(1/
                                                                                                                                                            teta))* ((-log(F1))^teta + (-log(F2))^teta)^(-2 + 1/
                                                                                                                                                                                                           teta)* (-log(F2))^(-1 + teta))/(F1 *F2)
      h2_deru2 <- c.copula2.be2 <- (1/(F2^2))*exp(-((-log(F2))^teta + (-log(F1))^teta)^((1/
                                                                                           teta)))* (-log(F2))^(-2 + 
                                                                                                                  teta) *((-log(F2))^teta + (-log(F1))^teta)^(-2 + 1/
                                                                                                                                                                teta)* ((-log(F2))^
                                                                                                                                                                          teta* (log(F2) + ((-log(F2))^teta + (-log(F1))^teta)^(1/
                                                                                                                                                                                                                                  teta)) + (1 - teta + log(F2))* (-log(F1))^teta)
        ...
        ngr <- (
          ...
          y[,2] * (  (1/pdffz(1-h1) * h1_deru2 * (-1) *df2))
          +
            (1 - y[,2]) * (dpdf2 +  1/pdffz(1-h2) * (-1)*h2_deru2 *(df2))
        )
  ...
  gradient_cop_gen <- function(cdf1, cdf2, rho){
    ...
    h1_derCop <- ((-log(F1))^(-1 + teta) * (((-log(F1))^teta * log(-log(F1)) +  (-log(F2))^teta * log(-log(F2))) * ((-log(F1))^teta + (-log(F2))^teta)^(1/teta -  2) * (1/teta - 1) - ((-log(F1))^teta + (-log(F2))^teta)^(1/teta - 
                                                                                                                                                                                                                                  1) * log((-log(F1))^teta + (-log(F2))^teta)/teta^2) + ((-log(F1))^(-1 + teta) * log(-log(F1)) - (-log(F1))^(-1 + teta) * (((-log(F1))^teta * 
                                                                                                                                                                                                                                                                                                                                                               log(-log(F1)) + (-log(F2))^teta * log(-log(F2))) * ((-log(F1))^teta + 
                                                                                                                                                                                                                                                                                                                                                                                                                     (-log(F2))^teta)^(1/teta - 1) - ((-log(F1))^teta + (-log(F2))^teta)^(1/teta) * 
                                                                                                                                                                                                                                                                                                                                                              log((-log(F1))^teta + (-log(F2))^teta)/teta)/teta) * ((-log(F1))^teta + 
                                                                                                                                                                                                                                                                                                                                                                                                                      (-log(F2))^teta)^(1/teta - 1)) * exp(-((-log(F1))^teta + 
                                                                                                                                                                                                                                                                                                                                                                                                                                                               (-log(F2))^teta)^(1/teta))/F1
    
    h2_derCop <-  ((-log(F2))^(-1 + teta) * (((-log(F1))^teta * log(-log(F1)) + 
                                                (-log(F2))^teta * log(-log(F2))) * ((-log(F1))^teta + (-log(F2))^teta)^(1/teta - 
                                                                                                                          2) * (1/teta - 1) - ((-log(F1))^teta + (-log(F2))^teta)^(1/teta - 
                                                                                                                                                                                     1) * log((-log(F1))^teta + (-log(F2))^teta)/teta^2) + ((-log(F1))^teta + 
                                                                                                                                                                                                                                              (-log(F2))^teta)^(1/teta - 1) * ((-log(F2))^(-1 + teta) * 
                                                                                                                                                                                                                                                                                 log(-log(F2)) - (-log(F2))^(-1 + teta) * (((-log(F1))^teta * 
                                                                                                                                                                                                                                                                                                                              log(-log(F1)) + (-log(F2))^teta * log(-log(F2))) * ((-log(F1))^teta + 
                                                                                                                                                                                                                                                                                                                                                                                    (-log(F2))^teta)^(1/teta - 1) - ((-log(F1))^teta + (-log(F2))^teta)^(1/teta) * 
                                                                                                                                                                                                                                                                                                                             log((-log(F1))^teta + (-log(F2))^teta)/teta)/teta)) * exp(-((-log(F1))^teta + 
                                                                                                                                                                                                                                                                                                                                                                                           (-log(F2))^teta)^(1/teta))/F2
  ...
  name_fam <- paste("GumbelCop", marg1$marg_name, marg2$marg_name)
  # quantile_function <- ...
  
  GumbelCopFam <- Families(name = name_fam)
  ...
  for(i in marg1$parameter_names){
    ...
    GumbelCopFam[[paste(i, "1", sep = "")]] <- fam_obj
  ...
  for(i in marg2$parameter_names){
    ...
    # saving the parameter specific family object in overall families object
    GumbelCopFam[[paste(i, "2", sep = "")]] <- fam_obj
  ...
  # body and arguments for gradient
  grad_body <- gradient_cop_gen(marg1[["generic"]]$cdf, marg2[["generic"]]$cdf, rho = rho_gen)
  grad_body <- exprs(!!grad_body,
                     ngr <- stabilize_ngradient(ngr, w = w, stabilization),
                     return(ngr))
  ...
  name_cop <- "Gumbel Copula: rho(... link)" 
